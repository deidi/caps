...
> **EventCaps** is a 100% serverless, client-first event photo sharing hub. It runs **entirely in your web browser** with zero dedicated backend servers, zero database costs, direct Google Drive cloud hosting for 100+ attendees, and real-time live slideshow.
...
- ☁️ **Direct Google Drive Cloud Hosting**: Direct HTTP photo uploads from 100+ guest smartphones directly into the host's personal Google Drive with high-speed Google CDN delivery.
